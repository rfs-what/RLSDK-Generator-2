...
public:
	ElementPointer Elements;										// 0x0000 (0x0008)
	...
	int32_t HashCount;												// 0x0058 (0x0004)
...
public:
	...
	uint8_t UnknownData01[0xC];																									// 0x0014 (0x0C)

#ifdef UTF16
	wchar_t			Name[0x400];			REGISTER_MEMBER(wchar_t, Name, EMemberTypes::FNAMEENTRY_NAME)						// 0x0020 (0x00)
#else
...
{
public:
	struct FPointer VfTableObject;			REGISTER_MEMBER(FPointer, VfTableObject, EMemberTypes::UOBJECT_VFTABLE)				// 0x0000 (0x08)
	...
	int32_t ObjectInternalInteger;			REGISTER_MEMBER(int32_t, ObjectInternalInteger, EMemberTypes::UOBJECT_INDEX)		// 0x0038 (0x04)
	...
	struct FName Name;						REGISTER_MEMBER(FName, Name, EMemberTypes::UOBJECT_NAME)							// 0x0048 (0x08)
...
public:
	...
	uint8_t UnknownData00[0x8];																									// 0x003C (0x08)
...
{
public:
	TArray<struct FName> Names;				REGISTER_MEMBER(TArray<struct FName>, Names, EMemberTypes::UENUM_NAMES)				// 0x0044 (0x10)
...
{
public:
	class FString Value;					REGISTER_MEMBER(FString, Value, EMemberTypes::UCONST_VALUE)							// 0x0044 (0x10)
...
{
public:
	uint32_t ArrayDim;						REGISTER_MEMBER(uint32_t, ArrayDim, EMemberTypes::UPROPERTY_DIMENSION)				// 0x0044 (0x04)
	uint32_t ElementSize;					REGISTER_MEMBER(uint32_t, ElementSize, EMemberTypes::UPROPERTY_SIZE)				// 0x0048 (0x04)
	...
	uint32_t PropertySize;																										// 0x0064 (0x04)
	uint8_t UnknownData01[0x4];																									// 0x0068 (0x04)
	uint32_t Offset;						REGISTER_MEMBER(uint32_t, Offset, EMemberTypes::UPROPERTY_OFFSET)					// 0x006C (0x04)
	uint8_t UnknownData02[0x2C];																								// 0x0070 (0x2C)
...
{
public:
	uint8_t UnknownData00[0x10];																								// 0x0044 (0x10)
	class UField* SuperField;				REGISTER_MEMBER(class UField*, SuperField, EMemberTypes::USTRUCT_SUPERFIELD)		// 0x0054 (0x08)
	class UField* Children;					REGISTER_MEMBER(class UField*, Children, EMemberTypes::USTRUCT_CHILDREN)			// 0x005C (0x08)
	uint32_t PropertySize;					REGISTER_MEMBER(uint32_t, PropertySize, EMemberTypes::USTRUCT_SIZE)					// 0x0064 (0x04)
	uint8_t UnknownData01[0x9C];																								// 0x0068 (0x9C)
...
public:
	...
	uint32_t ReturnValueOffset;																									// 0x0070 (0x04)
	uint8_t	UnknownData00[0xC];																									// 0x0074 (0x0C)
...
{
public:
	uint8_t UnknownData00[0x28]; // 0x0058 (0x28) [USE THIS CLASSES PROPERTYSIZE IN RECLASS TO DETERMINE THE SIZE OF THE UNKNOWNDATA]
...
{
public:
	uint8_t UnknownData00[0x60]; // 0x0058 (0x60) [USE THIS CLASSES PROPERTYSIZE IN RECLASS TO DETERMINE THE SIZE OF THE UNKNOWNDATA]
...
{
public:
	uint8_t UnknownData00[0x228]; // 0x0058 (0x228) [USE THIS CLASSES PROPERTYSIZE IN RECLASS TO DETERMINE THE SIZE OF THE UNKNOWNDATA]
...
{
public:
	class UClass* PropertyClass;			REGISTER_MEMBER(class UClass*, PropertyClass, EMemberTypes::UOBJECTPROPERTY_PROPERTY)	// 0x0058 (0x08)
	uint8_t	UnknownData00[0x8];																										// 0x0060 (0x08)											
...
{
public:
	class UClass* MetaClass;				REGISTER_MEMBER(class UClass*, MetaClass, EMemberTypes::UCLASSPROPERTY_METACLASS)		// 0x0058 (0x08)
...
{
public:
	class UFuncton* DelegateFunction;		REGISTER_MEMBER(class UFuncton*, Function, EMemberTypes::UDELEGATEPROPERTY_FUNCTION)		// 0x0058 (0x08)
	struct FName DelegateName;				REGISTER_MEMBER(FName, DelegateName, EMemberTypes::UDELEGATEPROPERTY_NAME)					// 0x0060 (0x08)
...
{
public:
	class UProperty* Inner;					REGISTER_MEMBER(class UProperty*, Inner, EMemberTypes::UARRAYPROPERTY_INNTER)				// 0x0058 (0x08)
